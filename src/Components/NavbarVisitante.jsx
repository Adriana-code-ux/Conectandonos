        ...
        <div className="contenido contenido flex flex-col sm:flex-row sm:justify-between sm:items-center">
          ...
          <nav className="desktop-nav ">
            <ul>
              ...
              <li className='ml-5 text-gray-700 hover:text-gray-900'><Link to="/iniciar-sesion">Iniciar sesion</Link></li>
              <li className='ml-5 text-gray-700 hover:text-gray-900'><Link to="/registrar-usuario">Registrarse</Link></li>
            </ul>
          </nav>
        </div>
      </div>
